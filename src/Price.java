...
public class Price implements ChangeListener, ChartProgressListener{
	...
	public Price(String applicationTitle, String chartTitle,
		...
		DateCellRenderer datecellrenderer = new DateCellRenderer(new SimpleDateFormat("dd-MMM-yyyy"));
	...
	public void chartProgress(ChartProgressEvent chartprogressevent) {
		...
		if (chartPanel != null)
		{
			...
			if (jfreechart != null)
			{
				...
				if (i >= 0)
				{
					TimeSeriesDataItem timeseriesdataitem = series.getDataItem(Math.max(0, i));
	...
	public void stateChanged(ChangeEvent e) {
		...
		double d = valueaxis.getLowerBound() + ((double)i / days) * range.getLength();
