...
public class Return2 {
	...
	public ArrayList<Trade2> trades;
	private ChartPanel chartPanel;
	private String company;

	public Return2(String applicationTitle, String chartTitle,
			ArrayList<Trade2> trades, String company) {
		this.trades = trades;
